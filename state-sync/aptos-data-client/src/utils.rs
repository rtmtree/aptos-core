...
#[cfg(test)]
mod tests {
    use crate::utils::{choose_random_peers_by_weight, is_priority_peer};
    use aptos_config::{
    ...
    fn test_choose_random_peers_by_weight() {
        // Choose 1 peer from an empty list, and verify an error is returned
        choose_random_peers_by_weight(1, vec![]).unwrap_err();
